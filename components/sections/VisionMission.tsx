...
export default function VisionMission() {
  ...
  return (
    <section className="relative py-32 overflow-hidden bg-brand-surface dark:bg-[#0D1B2A]/50">
      ...
      <div className="container max-w-7xl mx-auto px-6 relative z-10">
        <div className={cn(
          ...
          >
            ...
            <div className="relative h-full bg-white dark:bg-white/5 backdrop-blur-xl border border-brand-border dark:border-white/10 rounded-[2.5rem] p-10 md:p-14 overflow-hidden shadow-sm hover:shadow-2xl hover:shadow-brand-blue/10 transition-all duration-500">
              <div className="flex flex-col gap-8 h-full">
                <div className="w-16 h-16 rounded-2xl bg-brand-cyan/10 flex items-center justify-center text-brand-cyan group-hover:scale-110 transition-transform duration-500">
                  <Eye size={32} />
                </div>
                
                <div className="space-y-4">
                  <span className="text-xs font-black tracking-[0.3em] text-brand-cyan uppercase">
          ...
          <motion.div
            ...
            className="group relative"
          >
            <div className="absolute inset-0 bg-brand-cyan/5 rounded-[2.5rem] blur-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
            <div className="relative h-full bg-brand-navy dark:bg-white/5 backdrop-blur-xl border border-white/5 dark:border-white/10 rounded-[2.5rem] p-10 md:p-14 overflow-hidden shadow-2xl transition-all duration-500">
              <div className="flex flex-col gap-8 h-full">
                <div className="w-16 h-16 rounded-2xl bg-white/10 flex items-center justify-center text-brand-cyan group-hover:scale-110 transition-transform duration-500">
                  <Target size={32} />
                </div>
